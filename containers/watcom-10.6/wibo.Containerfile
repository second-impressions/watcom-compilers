...
#
# Watcom C/C++ 10.6 (GA, 1996) — wibo runtime image.
#
# Produces:
#     localhost/watcom-10.6-wibo        (binnt/ from the watcom-10.6-dosemu2 tree)
#
...
#
# Build:
#     podman build -t localhost/watcom-10.6-wibo -f containers/watcom-10.6/wibo.Containerfile .

FROM localhost/watcom-10.6-dosemu2 AS watcom
