...
#
# extract-10.5.sh — extract the Watcom C/C++ 10.5 install tree from the
# retail CD-ROM ISO into DEST_DIR.
#
# Usage:
#     extract-10.5.sh DEST_DIR [ISO]
#
# The 10.5 ISO root contains Win32 launcher stubs (not real compilers);
...
DEST="$1"
ISO="${2:-/archives/watcom-10.5/Watcom_C++_10.5.iso}"

[ -f "$ISO" ] || err "ISO not found: $ISO"

log "extract-10.5: dest   = $DEST"
log "extract-10.5: source = $ISO"
